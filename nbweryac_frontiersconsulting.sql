...
--
-- Database: `nbweryac_frontiersconsulting`
--
...
(5, '2022_11_10_053421_create_appointments_table', 1);
...
CREATE TABLE `users` (
  ...
  `national_insurance` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `work_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `start_work_date` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `birth_date` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `required_cis_registration` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
