...
<div class="register" id="register">
	<div class="container">
		<div class="row">
            ...
            {{-- Registration Session Message --}}
            @if (Session::has('utr_registration'))
                <div class="alert alert-success my-2">{{ Session::get('utr_registration') }}</div>
            @endif
            {{-- Registration Session Message --}}
			...
			<form class="row" method="POST" action="{{ route('utr-register-store') }}">
				@csrf
				<div class="col-md-6">
					<div class="row">
						<div class="col-md-12">
						...
						<div class="col-md-12">
							...
							<input type="text" class="form-control" name="number" id="number" aria-describedby="numberHelp" value="{{ old('number') }}" placeholder="0000000000" required />
                            @error('number')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
						...
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-md-12">
                                    ...
                                    @if (Session::has('required_CIS'))
                                        <div class="alert alert-danger mt-2">{{ Session::get('required_CIS') }}</div>
                                    @endif
								</div>
							</div>
						</div>
